...
$query_SacarListado = "SELECT * FROM z_posts ORDER BY puntos DESC";
...
<?php do { ?>
  <div id="section_l">
    <div id="tittle_h">
    <a href="<?php echo $row_SacarListado['urlamigable']; ?>.html"><?php echo $row_SacarListado['titulo']; ?> <span style="font-size:12px; color:#A09F9F; float: right;">(Puntos <?php echo $row_SacarListado['puntos']; ?>)</span></a>
     </div>
    <div id="post_info"><span class="in_txt"><img class="h_img" src="<?php echo $urlWeb ?>img/date.png" width="14" height="14" /><?php echo tiempo_transcurrido($row_SacarListado['fecha']); ?></span>
      <span class="in_txt"><img class="h_img" src="<?php echo $urlWeb ?>img/category.png" width="14" height="14" /><a href="#">Categoria</a></span>
      ...
      <span class="in_txt"><img class="h_img" src="<?php echo $urlWeb ?>img/permalink.png" width="14" height="14" /><a href="#">Enlace</a></span>
      </div>
    </div>
